        ...
        <div className="cards-issues">
            <div className="row">
                <div className="col-md-6 card-issue">
                    ...
                    <a href="/" className="btn-md btn-secondary card-issue__btn">CLEAR NOTIFCATION</a>
                </div>
                ...
                <div className="col-md-6 card-issue">
                    ...
                    <div className="card-issue__txt">
                        <p>We need your account number to send funds to <strong className="txt-mark">Resolve now</strong></p>
                    </div>
                    <a href="/" className="btn-md btn-danger card-issue__btn">RESOLVE NOW</a>
                </div>
            </div>
        </div>
    )
